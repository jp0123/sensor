...
/** Individual Sensor Arrays by ID */
const sensorA = data.filter(sensor => { return sensor.id === "a" });
const sensorB = data.filter(sensor => { return sensor.id === "b" });
const sensorC = data.filter(sensor => { return sensor.id === "c" });
